  ...
  return (
    <main className="bg-[#f3f3f3] text-[#1e2240]">
      ...
      <section className="mx-auto max-w-[1120px] px-4 py-12 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-[#4e516a]">At VERCEL4, we redefine the luxury car-buying experience with premium selection and dedicated support.</p>
      ...
      <section className="mx-auto max-w-[1120px] px-4 py-12">
        <div className="relative h-[320px] overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white">
            <h3 className="text-5xl font-semibold leading-tight">See what people have to say about <span className="font-serif italic text-[#f5c852]">VERCEL4</span></h3>
